  ...
  switch($todo){
    ...
    case 'readfavoris':
      if (isset($_REQUEST["idP"])){
        $idP = $_REQUEST["idP"];
        $data = readFavorisController($idP);
        break;
      }
      

    case 'ajoutfavori':
      if ( isset($_REQUEST["idP"]) && isset($_REQUEST["idF"])){
        $idP = $_REQUEST["idP"];
        $idF = $_REQUEST["idF"];
        $data = ajoutfavoriController($idP,$idF);
        break;
      }
    ...
    case 'enlevefavori':
      if ( isset($_REQUEST["idP"]) && isset($_REQUEST["idF"])){
        $idP = $_REQUEST["idP"];
        $idF = $_REQUEST["idF"];
        $data = enlevefavoriController($idP,$idF);
        break;
      }
    ...
    case 'verifierfavori':
      if ( isset($_REQUEST["idP"]) && isset($_REQUEST["idF"])){
        $idP = $_REQUEST["idP"];
        $idF = $_REQUEST["idF"];
        $data = verifierfavoriController($idP,$idF);
        break;
      }
    ...
    case "readmoviescategory" :
      if (isset($_REQUEST["categ"]) && isset($_REQUEST["ageP"])){
        $categ = $_REQUEST["categ"];
        $ageP = $_REQUEST["ageP"];
        $data = readmoviescategoryController($categ,$ageP);
        break;
      }
